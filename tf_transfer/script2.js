// uploading models by user - https://stackoverflow.com/questions/53639919/load-tensorflow-js-model-from-local-file-system-in-javascript
...
async function loadModel(){	
    ...
    model = await tf.loadLayersModel('http://0.0.0.0:8000/models/converted/initializer/model.json');    
    
    // warm start the model. speeds up the first inference
    model.predict(tf.zeros([1]))
